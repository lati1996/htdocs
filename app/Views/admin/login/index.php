                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="" method="post">
                                        <div class="form-group">
                                            <input name="user[username]" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Tài khoản...">
                                        </div>
                                        <div class="form-group">
                                            <input name="user[password]" type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Mật khẩu...">
                                        </div>
                                        <div class="form-group">
