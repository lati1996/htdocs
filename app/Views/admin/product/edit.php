                        ...
                        <form class="user" method="post" action="" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="form-control form-control-user" value="<?php echo $modelP->Size; ?>" id="" placeholder="Số lượng" name="product[Size]">
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="" value="<?php echo $modelP->Price; ?>" placeholder="Giá sản phẩm" name="product[Price]">
                                </div>
                            </div>
                            <div class="form-group row">
