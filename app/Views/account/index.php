    ...
    <div class="row py-5">
        <div class="row" style="margin-bottom:50px;">
            <div class="form-group col-md-12 mb-12 text-center">
                <label>
                    <h1 class="h2 text-success"><b>hT</b> Store</h1>
                    <p class="h2">Thông tin tài khoản</p>
                </label>
            </div>
        </div>
        <form class="col-md-9 m-auto" method="post" role="form" action="" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4 mb-3">
                    <label for="inputname">Nhập lại</label>
            ...
            <div class="row">
                <div class="form-group col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="user[Address]" placeholder="Địa chỉ" value="<?php echo $_SESSION["user"]["Address"]; ?>">
                </div>
                <div class="form-group col-md-3 mb-3">
