...
--
-- Host: localhost
-- Generation Time: Aug 26, 2023 at 11:38 AM
...
INSERT INTO `tbl_product` (`Id`, `ProductName`, `Description`, `IdCate`, `Image`, `Quantity`, `Size`) VALUES
(1, 'Bộ Drap gối', 'Bộ Drap gối', 1, '1', 10, '160x200x15cm'),
(4, 'Drap Cotton TL', 'Drap Cotton TL', 2, '1', 10, '160x200x10cm'),
(5, 'Áo gối', 'Áo gối', 7, '2', 100, '40x60cm');
